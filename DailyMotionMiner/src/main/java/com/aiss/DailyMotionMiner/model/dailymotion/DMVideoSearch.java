...
public class DMVideoSearch {
    ...
    @JsonProperty("list")
    private java.util.List<com.aiss.DailyMotionMiner.model.dailymotion.DMVideo> list;
    ...
    @JsonProperty("list")
    public java.util.List<com.aiss.DailyMotionMiner.model.dailymotion.DMVideo> getList() {
        return list;
    }

    @JsonProperty("list")
    public void setList(java.util.List<com.aiss.DailyMotionMiner.model.dailymotion.DMVideo> list) {
        this.list = list;
    }
