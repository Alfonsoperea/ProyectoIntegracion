...
public class DMSubtleSearch {
    ...
    @JsonProperty("list")
    private java.util.List<com.aiss.DailyMotionMiner.model.dailymotion.DMSubtle> list;
    ...
    @JsonProperty("list")
    public java.util.List<com.aiss.DailyMotionMiner.model.dailymotion.DMSubtle> getList() {
        return list;
    }

    @JsonProperty("list")
    public void setList(java.util.List<com.aiss.DailyMotionMiner.model.dailymotion.DMSubtle> list) {
        this.list = list;
    }
